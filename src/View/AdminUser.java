    ...
    private void editRoleBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editRoleBtnActionPerformed
        if(table.getSelectedRow() >= 0){
            ...
            if(result != null){
                ...
                //String selectedRole = String.valueOf(optionList.getSelectedItem());
                int newRole = 2;
                String roleString = "";
                
                if (result.equals("1-DISABLED")){
                    newRole = 1;
                    roleString = "disabled";
                } else if (result.equals("2-CLIENT")){
                    newRole = 2;
                    roleString = "client";
                } else if (result.equals("3-STAFF")){
                    newRole = 3;
                    roleString = "staff";
                } else if (result.equals("4-MANAGER")){
                    newRole = 4;
                    roleString = "manager";
                } else if (result.equals("5-ADMIN")){
                    newRole = 5;
                    roleString = "admin";
                }
                
                String username = String.valueOf(tableModel.getValueAt(table.getSelectedRow(), 0));
                sqlite.updateUserRole(newRole, username);
