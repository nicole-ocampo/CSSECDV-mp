 ...
 * @author beepxD
 */
public class AdminLogs extends javax.swing.JPanel {

    public SQLite sqlite;
    public DefaultTableModel tableModel;
    public String username;
    
    public AdminLogs(SQLite sqlite) {
        initComponents();
        this.sqlite = sqlite;
...
//      LOAD CONTENTS
    ...
    private void clearBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_clearBtnActionPerformed
        ...
        if (result == JOptionPane.YES_OPTION){
            ...
            // drop previous log table and create new log table
            sqlite.dropLogsTable();
            sqlite.createLogsTable();
            
            // log that previous logs were cleared
            Date date = new Date();  
            SimpleDateFormat formatter = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss.SSS");  
            String strDate = formatter.format(date);
            
            String event = "NOTICE";
            String description = "Admin cleared previous logs.";
            sqlite.addLogs(event, this.username, description , strDate);
        }
